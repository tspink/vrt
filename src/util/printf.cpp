 ...
 */
int vrt::util::snprintf(char *buffer, int size, const char *fmt, ...)
{
	int rc;
	va_list args;
 ...
 * @return The number of characters printed into the buffer
 */
int vrt::util::sprintf(char *buffer, const char *fmt, ...)
{
	int rc;
	va_list args;
...
int vrt::util::vsnprintf(char *buffer_base, int size, const char *fmt_base, va_list args)
{
